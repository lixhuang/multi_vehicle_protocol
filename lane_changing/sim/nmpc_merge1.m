function env = smpc_merge1
    ...
    %setup targets
    env.targets_num = 2;
    env.targets(1).q_init = [-18;-3.7;0;29];
    ...
    %setup methods
    env.Controller = @Ctrl_nmpc_vector_controller1; %controller function;
    ...
    env.Target_ctrl = @Script_replay_targets; %target script function;
